            ...
            <div class="col-xl-12 col-lg-8">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">New Sick Information</h4>
                     </div>
                  </div>
                  <div class="card-body">
                        ...
                        <form:form method="POST" action="/sick/save" modelAttribute="sick">
                           <div class="row">
                              <div class="form-group col-sm-12">
                                 <label class="form-label" for="sname">Sick's Name:</label>
                                 <form:input path ="name" class="form-control" type="text" id="sname" placeholder="Sick's Name" />
                              </div>
                           </div>
                           ...
                           <button type="submit" class="btn btn-primary">Add New Sick</button>
                           <form:hidden path="id" />
                        </form:form>
                     </div>
                  </div>
