        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-vaccine   ">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="./user-add.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-vaccine" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link active"  href="/vaccine/addnew">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <div class="col-xl-12 col-lg-8">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">New Vaccine Information</h4>
                     </div>
                  </div>
                  <div class="card-body">
                     <div class="new-user-info">
                        <form:form method="POST" action="/vaccine/save" modelAttribute="vaccine">
                           <div class="row">
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="vname">Vaccine's Name:</label>
                                 <form:input path ="name" class="form-control" type="text" id="vanme" placeholder="Vaccine's Name" />
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="supplier">Supplier</label>
                                 <form:input path ="supplier" class="form-control" type="text" id="supplier" placeholder="Supplier" />
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="nation">Nation</label>
                                 <form:input path ="nation" class="form-control" type="text" id="nation" placeholder="Nation" />
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="price">Price:</label>
                                 <form:input path ="price" class="form-control" type="text" id="price" placeholder="Price" />
                              </div>
                              <div class="form-group col-sm-12">
                                 <label class="form-label">Sicks:</label>                                 
                                 <form:select path="sick" class="selectpicker form-control" data-style="py-0">
                               ...
                               <div class="form-group col-md-6">
                                    <label class="form-label" for="note">Image Url:</label>
                                    <form:input path ="imgurl" class="form-control" type="text" id="imgurl" placeholder="Image Url" />
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label class="form-label" for="note">Image Title:</label>
                                    <form:input path ="imgtitle" class="form-control" type="text" id="imgtitle" placeholder="Image Title" />
                                 </div>
                                 <div class="form-group col-sm-12">
                                    <label class="form-label" for="note">Note:</label>
                                    <form:input path ="note" class="form-control" type="text" id="note" placeholder="Note" />
                                 </div>
                              </div>

                           <hr>
                           <div class="checkbox">
                              <label class="form-label"><input class="form-check-input me-2" type="checkbox" value="" id="flexCheckChecked">Confirm the information is absolutely correct</label>
                           </div>
