					...
					<li class="nav-item"><a class="nav-link"
						...
						<ul class="sub-nav collapse" id="sidebar-vaccine"
							...
							<li class="nav-item"><a class="nav-link active"
								href="/vaccince"> <i class="icon"> <svg
											xmlns="http://www.w3.org/2000/svg" width="10"
											viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12"
										...
										<tbody>
											<c:forEach items="${vaccines}" var="vaccine">
												<tr>
													...
													<td>${vaccine.sick}</td>
													<td>
												        <img class="img-thumbnail" src="${vaccine.imgurl}" alt="" width="100" height="100"">
													</td>
													...
													<td>
														<div class="flex align-items-center list-user-action">
															<a class="btn btn-sm btn-icon btn-success"
																...
																data-toggle="tooltip" data-placement="top" title=""
																data-original-title="Edit" href="/vaccine/edit/${vaccine.id}"> <span
																...
																data-toggle="tooltip" data-placement="top" title=""
																data-original-title="Delete" href="/vaccine/delete/${vaccine.id}"> <span
																class="btn-inner"> <svg width="20"
																		viewBox="0 0 24 24" fill="none"
																		xmlns="http://www.w3.org/2000/svg"
																		stroke="currentColor">
