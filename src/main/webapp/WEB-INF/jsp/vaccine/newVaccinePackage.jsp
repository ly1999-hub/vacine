                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-vaccine" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="/vaccine/addnew">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <div class="col-xl-12 col-lg-8">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">New Vaccine Package Information</h4>
                     </div>
                  </div>
                  <div class="card-body">
                        ...
                        <form:form method="POST" action="/vaccinepackage/save" modelAttribute="vaccinepackage">
                           <div class="row">
                              <div class="form-group col-sm-12">
                                 <label class="form-label" for="pname">Package's Name:</label>
                                 <form:input path ="name" class="form-control" type="text" id="pname" placeholder="Package's Name" />
                              </div>
                              <div class="form-group col-sm-12">
