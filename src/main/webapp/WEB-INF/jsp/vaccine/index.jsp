        ...
        <div class="main-img">
            <div class="container">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <div>
                        <a class="bg-white btn btn-light d-flex" target="_blank" href="./dashboard/">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane bd-heading-1 fade show active" id="content-Button-prv" role="tabpanel">
                                    ...
                                    <div class="bd-example">
                                        <button type="button" class="mr-2 btn btn-primary btn-xs">Ex small</button>
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Calendar-prv" role="tabpanel">
                                ...
                                <div class="bd-example">
                                    <div class="flex-row form-group vanila-daterangepicker d-flex">
                                ...
                                <div class="tab-pane bd-heading-1 fade show active" id="content-dropdown-prv" role="tabpanel">
                                    <div class="bd-example">
                                        <div class="flex-wrap btn-group w-100 align-items-center">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-secondary btn-lg dropdown-toggle me-2" type="button" id="dropdownMenuButtonLG" data-bs-toggle="dropdown" aria-expanded="false">
                                                Dropdown button
                                                </button>
                                    ...
                                    <div class="bd-example">
                                        <div class="flex-wrap btn-group w-100 align-items-center">
                                            ...
                                            <div class="dropstart">
                                                <button class="btn btn-secondary dropdown-toggle me-2" type="button" id="dropstartMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                                Dropstart button
                                                </button>
                                            ...
                                            <div class="btn-grp">
                                                <div class="dropdown">
                                                    <button class="btn btn-secondary dropdown-toggle me-2" type="button" id="dropdownRightMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                                    End-aligned menu
                                                    </button>
...
&#x3C;/div&#x3E;
    ...
    <div id ="back-to-top" style="display: none;">
        <a class="p-0 btn btn-primary btn-xs position-fixed top" id="top" href="#top">
