						...
						<div class="card">
							...
							<div class="card-body">
								<div class="new-user-info">
									<form:form method="POST" action="/sche	dule/save"
										...
										<div class="row">
											<div class="form-group col-md-6">
												<label class="form-label" for="name">Họ tên người
													tiêm:</label>
												<form:input cssClass="form-control" required ="required"
											...
											<div class="form-group col-md-6">
												<label class="form-label" for="birthday">Ngày sinh
													người tiêm:</label>
												<form:input path="dob" cssClass="form-control" required ="required" type="date" />
										...
										<div class="row">
											<div class="form-group col-md-6">
												<label class="form-label" for="uname">Họ tên người
													liên hệ:</label>
												<form:input path="fullNameGuardian" required ="required"
											...
											<div class="form-group col-md-6">
												...
												<form:input path="identityNumber" placeholder="CMND/CCCD" required ="required"
											...
											<div class="form-group col-md-6">
												...
												<form:select name="type" class="selectpicker form-control"
													path="relationship">
													<form:option value="Bản thân">Bản thân</form:option>
											...
											<div class="form-group col-md-6">
												...
												<form:input path="phoneguardian" cssClass="form-control" required ="required"
