						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header d-flex justify-content-between">
									<div class="header-title">
										<h4 class="card-title">Danh sách đăng ký tiêm</h4>
									</div>
								</div>
											...
											<tbody>
												<c:forEach items="${schedules}" var="schedule">
													<tr>
														...
														<td>${schedule.name}</td>
														<td>${schedule.dob}</td>
														<td><c:if test="${schedule.gender == 1}">
														Nam
														</c:if> <c:if test="${schedule.gender == 0}">
														Nữ
														</c:if></td>
														<td>${schedule.identityNumber}</td>
														<td>${schedule.address}</td>
														<td><c:if test="${schedule.status == false}">
																<div style="color: red;">đang chờ</div>

															</c:if> <c:if test="${schedule.status == true}">
														đã tiêm
														</c:if></td>
														<td>
															<div class="flex align-items-center list-user-action">
																<a class="btn btn-sm btn-icon btn-success"
																	...
																	href="/schedule/edit2/${schedule.id}"> <span
                                                   ...
                                                   <path
                                                        ...
                                                        16.36 7.17 16.69 7.33 16.95C7.49 17.2 7.78 17.35 8.08 17.31Z"
																	...
																	href="/schedule/edit/${schedule.id}"> <span
                                                 ...
                                                 <path
																	...
																	href="/schedule/delete/${schedule.id}"> 
																	<span
																	class="btn-inner"> <svg width="20"
																			viewBox="0 0 24 24" fill="none"
																			xmlns="http://www.w3.org/2000/svg"
