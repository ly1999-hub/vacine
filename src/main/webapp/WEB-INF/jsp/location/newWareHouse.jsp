                             ...
                             <li class="nav-item">
                                <a class="nav-link " href="/warehouse">
                                    ...
                                    <span class="item-name"> WareHouse  List</span>
                                       ...
                                       <li class="nav-item">
                                <a class="nav-link active " href="/warehouse/addnew">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
					...
					<div class="col-xl-12 col-lg-8">
						<div class="card">
							<div class="card-header d-flex justify-content-between">
								<div class="header-title">
									<h4 class="card-title">New WareHouse Information</h4>
								</div>
							</div>
							<div class="card-body">
								<div class="new-user-info">
									<form:form action="/warehouse/save" method="POST"
										modelAttribute="warehouse">

										<div class="row">
											<div class="form-group col-md-6">
												<form:label class="form-label" path="locationID"
													for="vname">LocationID</form:label>
												<form:input type="text" class="form-control" required ="required"
													path="locationID" id="locationid"
													placeholder="LocationID" />
											</div>
											<div class="form-group col-md-6">
												<form:label class="form-label" path="vaccineID"
													for="vname">VaccineID</form:label>
												<form:input type="text" class="form-control" required ="required"
													path="vaccineID" id="vaccineid"
													placeholder="VaccineID" />
											</div>
											
										<div class="form-group col-md-6">
												<form:label class="form-label" path="avaiableAmount"
													for="vname">AvaiableAmount</form:label>
												<form:input type="text" class="form-control" required ="required"
													path="avaiableAmount" id="avaiableamount"
													placeholder="AvaiableAmount" />
											</div>
												<div class="form-group col-md-6">
												<form:label class="form-label" path="totalMoney"
													for="vname">TotalMoney</form:label>
												<form:input type="text" class="form-control" required ="required"
													path="totalMoney" id="totalmoney"
													placeholder="TotalMoney" />
											</div>
									

											<div class="form-group col-md-12">
												<form:label class="form-label" path="note" for="vname">Note</form:label>
