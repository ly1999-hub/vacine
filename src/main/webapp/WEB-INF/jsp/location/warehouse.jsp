                            ...
                            <tbody>
                               <c:forEach items="${warehouses}" var="warehouse">
								...
								<td>${warehouse.locationID}</td>
									...
									<td>${warehouse.avaiableAmount}</td>
									<td>${warehouse.totalMoney}</td>
				                    ...
				                    <td>
                                     <div class="flex align-items-center list-user-action">
                                        ...
                                        <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="/warehouse/edit/${warehouse.id}">
                                           <span class="btn-inner">
                                              <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="/warehouse/delete/${warehouse.id}">
                                           <span class="btn-inner">
