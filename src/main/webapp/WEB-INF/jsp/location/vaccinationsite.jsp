						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header d-flex justify-content-between">
									<div class="header-title">
										<h4 class="card-title">VaccinationSite List</h4>
									</div>
								</div>
								<div class="card-body px-0">
									<div class="table-responsive">
										<table id="user-list-table" class="table table-striped"
											...
											<tbody>
												<c:forEach items="${vaccinationsites}" var="vaccinationsite">
													<tr>
														
														<td>${vaccinationsite.locationName}</td>
														<td>${vaccinationsite.wardName}</td>
														<td>${vaccinationsite.districtName}</td>
														<td>${vaccinationsite.cityName}</td>
														<td>${vaccinationsite.note}</td>
														<td>
															<div class="flex align-items-center list-user-action">
																<a class="btn btn-sm btn-icon btn-success"
																	data-toggle="tooltip" data-placement="top" title=""
																	data-original-title="Add" href="#"> <span
                                                 ...
                                                 <path
																	...
																	href="/vaccinationsite/edit/${vaccinationsite.id}">
                                                 ...
                                                 <path
																	...
																	href="/vaccinationsite/delete/${vaccinationsite.id}">
																	<span class="btn-inner"> <svg width="20"
																			viewBox="0 0 24 24" fill="none"
																			xmlns="http://www.w3.org/2000/svg"
																			stroke="currentColor">
