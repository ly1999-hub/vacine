                                ...
                                <form:form method="post" action="/doctor/save " modelAttribute="doctor">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <form:input type="text" class="form-control" path="note" placeholder="Note....."/>
                                        </div>
                                    </div>
                                    <hr>
                                    <button type="submit" class="btn btn-primary">Update Doctor</button>
                                    <form:hidden value="${doctor.doctorID}" path="doctorID"/>
                                    <form:hidden value="${doctor.userName}" path="userName"/>
                                    <form:hidden value="${doctor.password}" path="password"/>
                                </form:form>
                            </div>
                        </div>
                    </div>
