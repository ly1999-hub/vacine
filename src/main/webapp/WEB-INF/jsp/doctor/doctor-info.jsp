      ...
      <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <li class="nav-item">
          ...
          <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/doctor-add">
                <i class="icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                    <g>
                      <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="new-user-info">
                <form:form method="post" action="" modelAttribute="doctor">
                  <div class="row">
                    <div class="form-group col-md-6">
                      <form:label class="form-label" for="name" path="fullname">Name:</form:label>
                      <form:input type="text" class="form-control" id="name" path="fullname" value="${doctor.fullname}"/>
                    </div>
                    <div class="form-group col-md-6">
                      <form:label class="form-label" path="indentityNumber" >CMND/CCCD:</form:label>
                      <form:input type="text" class="form-control" id="cmnd" path="indentityNumber" value="${doctor.indentityNumber}"/>
                    </div>
                    <div class="form-group col-md-6">
                      <form:label class="form-label" path="academicLevel" >Academic Level:</form:label>
                      <form:input type="text" class="form-control" id="academicLevel" path="academicLevel" value="${doctor.academicLevel}"/>
                    </div>
                    <div class="form-group col-md-6">
                      <form:label class="form-label" path="specialized" >Specialized:</form:label>
                      <form:input type="text" class="form-control" id="specialized" path="specialized" value="${doctor.specialized}"/>
                    </div>
                    <div class="form-group col-md-12">
                      <form:label class="form-label" path="mail" >Email:</form:label>
                      <form:input type="email" class="form-control" path="mail" value="${doctor.mail}"/>
                    </div>
                    <div class="form-group col-md-6">
                      <form:label class="form-label" path="phoneNumber">Mobile Number:</form:label>
                      <form:input type="text" class="form-control"  path="phoneNumber" value="${doctor.phoneNumber}"/>
                    </div>


                    <div class="form-group col-md-6">
                      <form:label class="form-label" path="location">WorkPlace:</form:label>
                      <form:input type="text" class="form-control"  path="location" value="${doctor.location}"/>
                    </div>

                    <div class="form-group col-md-12">
                      <form:label class="form-label" path="imagePath" >Avatar Path:</form:label>
                      <form:input type="text" class="form-control" path="imagePath" value="${doctor.imagePath}"/>
                    </div>
                    <div class="form-group col-md-6">
                      <form:label class="form-label" path="note">Note:</form:label>
                      <form:input type="text" class="form-control" path="note" value="${doctor.note}"/>
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <form:input type="text" class="form-control" path="userName" value="${doctor.userName}"/>
                    </div>
                    <div class="form-group col-md-6">
                      <form:label class="form-label" path="password" >Password:</form:label>
                      <form:input type="text" class="form-control" path="password" value="${doctor.password}"/>
                    </div>
                  </div>
                </form:form>
              </div>
